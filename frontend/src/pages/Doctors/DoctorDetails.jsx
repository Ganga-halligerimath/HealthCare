        ...
        <div className="flex items-center gap-5">
          ...
          <div>
            ...
            leading-4 lg:text-[16px] lg:leading-7 font-semibold rounded'>
              ...
              <h3 className='text-headingColor text-[22px] leading-9 mt-3 font-blod'>
                Dr.Saleh Mahmud
                </h3>
                <div className='flex items-center gap-[6px]'>
                  ...
                  <span className='text-[14px] leading-5 lg:text-[16px] lg:leading-7 font-semiblod text-textColor'>(272)</span>
                </div>

                <p className='text__para text-[14px] leading-6 md:text-[15px] max-w-[390px]'>
                  Doctors have a big responsibilty to bring smile on the faces of sufering humanity.
                  </p>
          </div>
