        ...
        <div className="rounded-l-lg lg:pl-16 py-10">
          ...
          <div className="mb-5">
            ...
            <div className='mb-5 flex items-center gap-3'>
              { selectedFile && <figure className="w-[60px] h-[u60px] rounded-full border-2 border-solid
               border-primaryColor flex items-center justify-center">
                <img 
                src={previewURL} 
                alt="" 
                className='w-full-ronded-full'
                 />
              </figure>} 
              ...
              <div className="relative w-[130px] h-[50px]">
                ...
                <label htmlFor="cutomFile" 
                className='absolute top-0 left-0 w-full h-full flex 
                items-center px-[0.75rem] py-[0.375rem] text-[15px] leading-6 oveflow-hidden bg-[#0066ff46] text-headingColor font-semibold rounded-lg truncate 
                cursor-pointer'>
                  Upload Photo
                </label>
              </div>
